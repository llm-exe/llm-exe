...
| bot-respond | `Bash,Read,Write,Edit,Glob,Grep,WebFetch,WebSearch` | 50 | `vars.ANTHROPIC_OPUS_LATEST` or `claude-opus-4-6` |
...
| Timeout | 20 minutes |
| Tools | Full write set (`Bash,Read,Write,Edit,Glob,Grep,WebFetch,WebSearch`); 50 turns; `vars.ANTHROPIC_OPUS_LATEST` or `claude-opus-4-6` |
